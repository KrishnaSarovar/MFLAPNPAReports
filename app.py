...
def mf_sourcing(df_raw):
    ...
    rejected_count_col = "Login & Approval taken After 1st Mar'25 | Rejected | Count"
    rejected_value_col = "Login & Approval taken After 1st Mar'25 | Rejected | Value (In Cr.)"
    credit_login_count_col = "Login & Approval taken After 1st Mar'25 | Login | Count"
    credit_login_value_col = "Login & Approval taken After 1st Mar'25 | Login | Value (In Cr.)"
    approved_count_col = "Login & Approval taken After 1st Mar'25 | Approved | Count"
    approved_value_col = "Login & Approval taken After 1st Mar'25 | Approved | Value (In Cr.)"
    rfd_count_col = "Login & Approval taken After 1st Mar'25 | RFD | Count"
    rfd_value_col = "Login & Approval taken After 1st Mar'25 | RFD | Value (In Cr.)"
    disb_count_col = "Login & Approval taken After 1st Mar'25 | Disbursed | Count"
    disb_value_col = "Login & Approval taken After 1st Mar'25 | Disbursed | Value (In Cr.)"
    legal_approved_count_col = "Login & Approval taken After 1st Mar'25 | Legal Approved | Count"
    legal_approved_value_col = "Login & Approval taken After 1st Mar'25 | Legal Approved | Value (In Cr.)"
